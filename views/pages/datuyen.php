...
<div class="title_chitiet">
	<h3 >Tuyển dụng/<span style="font-size: 25px;">Hồ sơ đã ngưng tuyển</span><img src="upload/off.png" width="15px" style="margin-left: 5px;"></h3>
</div>
			...
			<div class="row">
				...
				<?php 	while ($row = $data->fetch_assoc()) {
					...
					<div class="show col-12 col-sm-6 col-md-4 col-lg-3">
						<a href="?controller=job&action=datuyen&id=<?=$row['id']?>">
